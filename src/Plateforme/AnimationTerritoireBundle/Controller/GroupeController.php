...
namespace Plateforme\AnimationTerritoireBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;

use Plateforme\AnimationTerritoireBundle\Entity\Groupe;
use Plateforme\AnimationTerritoireBundle\Form\GroupeType;
...
class GroupeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PlateformeAnimationTerritoireBundle:Groupe')->findAll();

        return $this->render('PlateformeAnimationTerritoireBundle:Groupe:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PlateformeAnimationTerritoireBundle:Groupe:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PlateformeAnimationTerritoireBundle:Groupe')->find($id);
        ...
        return $this->render('PlateformeAnimationTerritoireBundle:Groupe:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PlateformeAnimationTerritoireBundle:Groupe:edit.html.twig', array(
            'entity'      => $entity,
